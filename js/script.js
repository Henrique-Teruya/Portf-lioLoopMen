document.addEventListener('DOMContentLoaded', () => {
    ...
    const galleryImages = document.querySelectorAll('.ilustracao-item img, .estampa-item img, .ilustracao-item-wide img, .ticker__item img, .highlight-item img');
    ...
    galleryImages.forEach(img => {
        img.addEventListener('click', (e) => {
            ...
            const container = img.closest('.grid-ilustracoes, .ticker__list, .certificados, .projeto-secao, .highlights-feed, .highlights-section');
            if (container) {
                // Pegamos apenas as imagens que fazem parte da galeria dentro deste contêiner
                currentGroup = Array.from(container.querySelectorAll('.ilustracao-item img, .estampa-item img, .ilustracao-item-wide img, .ticker__item img, .highlight-item img'));
